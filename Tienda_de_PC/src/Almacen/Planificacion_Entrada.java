 ...
 * @author score
 */
public class Planificacion_Entrada extends javax.swing.JFrame {

    /**
     * Creates new form Planificacion_Entrada
     */
    public Planificacion_Entrada() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Suplidor", "Almacen", "Fecha", "Fase"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Planificacion_Entrada.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Planificacion_Entrada().setVisible(true);
            }
        });
    }
